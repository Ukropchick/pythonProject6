...
class Test(unittest.TestCase):
    ...
    def test_count_substrings(self):
        self.assertEqual(
            ...
            count_substrings("/input/substrings_in1.txt", ["РАЗНЫЕ", "ные", "Неряшливость", "е", "эволюция"])
        )
        self.assertEqual(
            {"Карминовый": 2, "Некрасивый": 2, "белоглазый": 1},
            count_substrings("/input/substrings_in1.txt", ["Карминовый", "Некрасивый", "белоглазый"])
        )
        self.assertEqual(
            {"--": 4, "ее": 2, "животное": 2, ".": 2},
            count_substrings("/input/substrings_in1.txt", ["--", "ее", "животное", "."])
        )
        self.assertEqual(
            {"Карминовый": 2, "Некрасивый": 2, "белоглазый": 1},
            count_substrings("/input/substrings_in1.txt", ["Карминовый", "Некрасивый", "белоглазый"])
